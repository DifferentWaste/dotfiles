...
sudo pacman -Syu amd-ucode apparmor bitwarden btop breeze breeze-gtk dunst efibootmgr feh ffmpegthumbnailer firefox firejail git gnome-boxes grim gtk4 gvfs gvfs-gphoto2 gvfs-mtp htop hypridle hyprland hyprlang hyprlock hyprpaper hyprutils iwd kate kde-gtk-config kitty kscreen kvantum kwayland-integration libreoffice-fresh lxappearance man-db man-pages materia-gtk-theme nano networkmanager noto-fonts-emoji nwg-look os-prober otf-font-awesome pacman-contrib pavucontrol pipewire pipewire-alsa pipewire-jack pipewire-pulse plasma-desktop plasma-integration qbittorrent qt5-wayland qt5ct qt6-wayland reflector signal-desktop slurp smartmontools sof-firmware solaar starship steam sway thunar thunar-volman ttf-firacode-nerd ttf-liberation ttf-terminus-nerd tumbler udisks2-qt5 ufw unzip veracrypt vim vlc vlc-plugins-all vulkan-radeon vulkan-tools waybar wget wireless_tools wl-clipboard wofi xdg-desktop-portal-hyprland xdg-utils 
